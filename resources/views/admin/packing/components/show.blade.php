        ...
        <section class="section">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover table-md">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">{{ number_format($data['resi']->tarif) }}</td>
                                    </tr>
                                </table>
                            </div>
                            <div class="row mt-2">
            ...
            <div class="invoice">
                <div class="invoice-print">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-12">
                            <h3 class="text-center" style="text-color: black;"><u>Resi Pengiriman Langsung</u></h3>
                            <div class="row">
                                <div class="col-md-6">
                                    <p>Tanggal : {{ $data['resi']->created_at->format('l, d F Y') }}</p>
                                </div>
                                <div class="col-md-6 text-md-right">
                                    <p>No Polisi : B 9679 NJ</p>
                                </div>
