...
@section('content')
    <div class="slider">
        <div class="slide-carousel owl-carousel">
            <div class="item" style="background-image:url({{ asset('dist-front/uploads/slide1.jpg') }});">
                <div class="bg"></div>
                <div class="text">
            ...
            <div class="item" style="background-image:url({{ asset('dist-front/uploads/slide2.jpg') }});">
                <div class="bg"></div>
                <div class="text">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="inner">
                        <div class="photo">
                            <img src="{{ asset('dist-front/uploads/1.jpg') }}" alt="">
                        </div>
                        <div class="text">
                ...
                <div class="col-md-3">
                    <div class="inner">
                        <div class="photo">
                            <img src="{{ asset('dist-front/uploads/2.jpg') }}" alt="">
                        </div>
                        <div class="text">
                            <h2><a href="">Standard Couple Bed</a></h2>
                            <div class="price">
                ...
                <div class="col-md-3">
                    <div class="inner">
                        <div class="photo">
                            <img src="{{ asset('dist-front/uploads/3.jpg') }}" alt="">
                        </div>
                        <div class="text">
                            <h2><a href="">Standard Couple Bed</a></h2>
                            <div class="price">
                ...
                <div class="col-md-3">
                    <div class="inner">
                        <div class="photo">
                            <img src="{{ asset('dist-front/uploads/4.jpg') }}" alt="">
                        </div>
                        <div class="text">
                            <h2><a href="">Standard Couple Bed</a></h2>
                            <div class="price">
                ...
                <div class="col-md-3">
                    <div class="inner">
                        <div class="photo">
                            <img src="{{ asset('dist-front/uploads/5.jpg') }}" alt="">
                        </div>
                        <div class="text">
                            <h2><a href="">Standard Couple Bed</a></h2>
                            <div class="price">
                ...
                <div class="col-md-3">
                    <div class="inner">
                        <div class="photo">
                            <img src="{{ asset('dist-front/uploads/6.jpg') }}" alt="">
                        </div>
                        <div class="text">
                            <h2><a href="">Standard Couple Bed</a></h2>
                            <div class="price">
                ...
                <div class="col-md-3">
                    <div class="inner">
                        <div class="photo">
                            <img src="{{ asset('dist-front/uploads/7.jpg') }}" alt="">
                        </div>
                        <div class="text">
                            <h2><a href="">Standard Couple Bed</a></h2>
                            <div class="price">
    ...
    <div class="testimonial" style="background-image: url({{ asset('dist-front/uploads/slide2.jpg') }})">
        <div class="bg"></div>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
